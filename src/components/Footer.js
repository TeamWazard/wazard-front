...
const Contents_p = styled.p`
  font-family: "Goldman", cursive;
  font-size: 12px;
`;

const Contents_link = styled.div`
  font-size: 12px;
  /* font-family: "Goldman", cursive; */
  ...
  a {
    margin-right: 10px;
    padding-right: 10px;
    border-right: 1px solid #afafaf; /* Add this line */
    text-decoration: none;
    color: #afafaf;
  }
`;
const CatholicLogo = styled.img`
  width: auto;
  height: 25px;
`;
...
const Contents_icon = styled.div`
  display: flex;
  justify-content: center;
`;
  ...
  return (
    <FooterContainer>
      <FooterMain>
        <Title>Wazard</Title>
        <Contants>
          <Contents_p>copyright © TeamWazard</Contents_p>
          <Contents_link>
            {" "}
            <a> 개발자 소개 </a>
            <a> 팀 소개 </a>
            <a style={{ borderRight: "none" }}> 개발 목적 </a>
            <br />
            <Contents_icon>
              <A_Link>
                <Svg
            ...
            <p>
              <CatholicLogo
                class="only_desktop"
                src="https://www.catholic.ac.kr/front_cuk/imgs/common/logo_header.png"
                alt="가톨릭대학교||the catholic university of korea"
              />
            </p>
          </Contents_link>
        </Contants>
